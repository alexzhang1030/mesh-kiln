...
| Needle Mesh Baker feature parity | [needle-parity.md](needle-parity.md) | Default workbench: budget or surface error, geometry only, Unlit, channel views. Cloud/AO/impostors stay out. |
